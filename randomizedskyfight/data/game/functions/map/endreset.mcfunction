...
#setblock 0 90 4 minecraft:player_wall_head[facing=south]{Owner:{Name:"CHGamingFreund"}}
...
summon armor_stand 0 89 4 {Rotation:[180f],Invulnerable:1b,PersistenceRequired:1b,NoBasePlate:1b,NoGravity:1b,ShowArms:1b,ArmorItems:[{id:"leather_boots",Count:1b,tag:{display:{color:16760576}}},{id:"leather_leggings",Count:1b,tag:{display:{color:16760576}}},{id:"leather_chestplate",Count:1b,tag:{display:{color:16760576}}},{id:"player_head",Count:1b,tag:{SkullOwner:"CHGamingFreund"}}],HandItems:[{id:"command_block",Count:1b},{}],CustomName:"{\"text\":\"rafaelurben - Technik\",\"color\":\"gold\"}",CustomNameVisible:1b,DisabledSlots:2039583,Pose:{RightArm:[326f,0f,16f]}}
